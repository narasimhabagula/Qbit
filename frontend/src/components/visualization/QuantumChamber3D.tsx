...
const HARDWARE_HOTSPOTS: Hotspot[] = [
  {
    ...
    category: 'Cryogenic Chandelier',
    description: 'Multi-stage closed-cycle dilution refrigerator using a ³He/⁴He mixture to cool the system down to 15 millikelvin, eliminating thermal decoherence.',
  ...
  },
  {
    ...
    category: 'Quantum Processor Core',
    description: 'A quantum processor containing superconducting circuits (transmon qubits) patterned on silicon, operating via Josephson junctions in quantum superposition.',
    spec: '127 Transmon Qubits • Coherence T₁ = 118 μs',
  ...
  {
    id: 'shields',
    name: 'Cryogenic Stage Shields',
    category: 'Thermal Radiation Isolation',
    description: 'Gold-plated OFHC copper radiation shields and thermal anchoring stages at 50K, 4K, 800mK, and 100mK isolating the processor from thermal blackbody noise.',
    spec: 'OFHC Gold-Plated Copper • Magnetic Mu-Metal Shielding',
    position3D: new THREE.Vector3(-0.6, 0.55, 0.3),
  },
  {
    id: 'readout',
    name: 'Dispersive Readout System',
  ...
  {
    id: 'mixing',
    name: 'Mixing Chamber Stage',
    category: 'Base Temperature Flange',
    description: 'The lowest stage of the cryostat where phase separation of ³He and ⁴He provides the cooling power directly to the magnetic package of the quantum processor.',
    spec: 'Base Temperature: 15.2 mK • Cooling Power: 250 μW',
